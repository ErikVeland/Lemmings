...
require(catalogue.levels.count == 120, "Expected the complete original catalogue")
var rateContexts = 0
...
print("PASS: 120 hint decks; \(rateContexts) release-rate contexts; event ordering and spoiler boundaries")
