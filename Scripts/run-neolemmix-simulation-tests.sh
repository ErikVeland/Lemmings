...
project_dir="${0:A:h:h}"
build_dir="$project_dir/.build/neolemmix-simulation-tests"
...
swiftc -swift-version 6 -warnings-as-errors \
  ...
  -o "$build_dir/NeoLemmixSimulationTests" \
  "$project_dir/Tests/NeoLemmixSimulationTests/main.swift"

"$build_dir/NeoLemmixSimulationTests"
