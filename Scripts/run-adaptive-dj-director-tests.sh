...
set -euo pipefail
project_dir="${0:A:h:h}"
build_dir="$project_dir/.build/adaptive-dj-director-tests"
...
swiftc -swift-version 6 -warnings-as-errors \
  ...
  -o "$build_dir/AdaptiveDJDirectorTests" \
  "$project_dir/Tests/AdaptiveDJDirectorTests/main.swift"
"$build_dir/AdaptiveDJDirectorTests"
