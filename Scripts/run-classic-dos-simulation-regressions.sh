...
project_dir="${0:A:h:h}"
build_dir="$project_dir/.build/classic-dos-simulation-regressions"
...
swiftc -swift-version 6 -warnings-as-errors \
  ...
  -o "$build_dir/ClassicDOSSimulationRegressions" \
  "$project_dir/Tests/ClassicDOSSimulationRegressions/main.swift"

/usr/bin/time -p "$build_dir/ClassicDOSSimulationRegressions" "$classic_data_dir"
