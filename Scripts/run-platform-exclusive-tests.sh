...
project_dir="${0:A:h:h}"
build_dir="$project_dir/.build/platform-exclusive-tests"
...
swiftc -swift-version 6 \
  ...
  -o "$build_dir/PlatformExclusiveTests" \
  "$project_dir/Tests/PlatformExclusiveTests/main.swift"

"$build_dir/PlatformExclusiveTests"
