...
set -euo pipefail
project_dir="${0:A:h:h}"
build_dir="$project_dir/.build/amiga-artwork-tests"
mkdir -p "$build_dir/modules"
cd "$project_dir"
python3 Tools/AmigaArtwork/prepare.py .build/amiga-artwork/export
...
swiftc -swift-version 6 -warnings-as-errors \
  ...
  -o "$build_dir/AmigaArtworkTests" Tests/AmigaArtworkTests/main.swift
"$build_dir/AmigaArtworkTests"
