...
set -euo pipefail
project_dir="${0:A:h:h}"
build_dir="$project_dir/.build/amiga-palette-tests"
...
swiftc -swift-version 6 -warnings-as-errors \
  ...
  -o "$build_dir/AmigaPaletteTests" "$project_dir/Tests/AmigaPaletteTests/main.swift"
"$build_dir/AmigaPaletteTests"
