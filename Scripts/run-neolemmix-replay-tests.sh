...
project_dir="${0:A:h:h}"
build_dir="$project_dir/.build/neolemmix-replay-tests"
...
swiftc -swift-version 6 -warnings-as-errors \
  ...
  -o "$build_dir/NeoLemmixReplayTests" \
  "$project_dir/Tests/NeoLemmixReplayTests/main.swift"

"$build_dir/NeoLemmixReplayTests"
