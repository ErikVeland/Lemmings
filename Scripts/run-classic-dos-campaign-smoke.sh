...
project_dir="${0:A:h:h}"
build_dir="$project_dir/.build/classic-dos-campaign-smoke"
...
swiftc -swift-version 6 -warnings-as-errors \
  ...
  -o "$build_dir/ClassicDOSCampaignSmoke" \
  "$project_dir/Tests/ClassicDOSCampaignSmoke/main.swift"

"$build_dir/ClassicDOSCampaignSmoke" "$classic_data_dir"
