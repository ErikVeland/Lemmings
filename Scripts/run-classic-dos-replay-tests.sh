...
project_dir="${0:A:h:h}"
build_dir="$project_dir/.build/classic-dos-replay-tests"
...
swiftc -swift-version 6 -warnings-as-errors \
  ...
  -o "$build_dir/ClassicDOSReplayTests" \
  "$project_dir/Tests/ClassicDOSReplayTests/main.swift"

"$build_dir/ClassicDOSReplayTests" "$classic_data_dir"
