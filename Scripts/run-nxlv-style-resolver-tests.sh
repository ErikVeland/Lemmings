...
project_dir="${0:A:h:h}"
build_dir="$project_dir/.build/nxlv-style-resolver-tests"
...
swiftc -swift-version 6 -parse-as-library \
  ...
  -o "$build_dir/NxlvStyleResolverTests" \
  "$project_dir/Tests/NxlvStyleResolverTests/main.swift"

"$build_dir/NxlvStyleResolverTests"
