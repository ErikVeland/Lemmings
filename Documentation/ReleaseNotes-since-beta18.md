...
Cumulative notes for upgrading from beta 18 to beta 23.
Version 0.1, build 23. Universal Mac app for Intel and Apple silicon, macOS 13 or later.
...
- Hold Shift, Speed or the right trigger for a temporary boost. Release to return to the previous speed.
...
## Beta 23 validation and remaining limits

Both complete app journeys pass on Apple silicon and Intel under Rosetta, along with all 25 core/resource regression suites.
...
The standard beta 23 archive is signed, notarised and Gatekeeper verified, with local records. The separate Game Center archive supports the two registered test Macs and cannot be notarised.
